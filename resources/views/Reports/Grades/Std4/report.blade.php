...
<table class="mmm" style="margin-top:-3.5%; border-collapse:collapse;" border="1" >
    ...
    <tr>
        ...
        <td class="centered">{{$max1 = \App\Models\Grades\Std4::maxMath($results->term)}}</td>
    ...
    <tr>
        ...
        <td class="centered">{{round($avg1 =\App\Models\Grades\Std4::avgMath($results->term))}}</td>
        <td class="centered">{{round($avg2 =\App\Models\Grades\Std4::avgEng($results->term))}}</td>
        <td class="centered">{{round($avg3 =\App\Models\Grades\Std4::avgKis($results->term))}}</td>
        <td class="centered">{{round($avg4 =\App\Models\Grades\Std4::avgScTec($results->term))}}</td>
        <td class="centered">{{round($avg4 =\App\Models\Grades\Std4::avgCivMor($results->term))}}</td>
        <td class="centered">{{round($avg4 =\App\Models\Grades\Std4::avgSs($results->term))}}</td>
        <td class="centered">{{round($avg4 =\App\Models\Grades\Std4::avgVS($results->term))}}</td>
