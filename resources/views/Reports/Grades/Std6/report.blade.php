...
<table class="mmm" style="margin-top:-3.5%; border-collapse:collapse;" border="1" >
    ...
    <tr>
        ...
        <td>{{$max1 = \App\Models\Grades\Std6::maxMath($results->term)}}</td>
    ...
    <tr>
        ...
        <td>{{$avg1 = \App\Models\Grades\Std6::avgMath($results->term)}}</td>
        <td class="centered">{{$avg2 = \App\Models\Grades\Std6::avgEng($results->term)}}</td>
        <td class="centered">{{$avg3 = \App\Models\Grades\Std6::avgKis($results->term)}}</td>
        <td class="centered">{{$avg4 = \App\Models\Grades\Std6::avgSc($results->term)}}</td>
        <td class="centered">{{$avg5 = \App\Models\Grades\Std6::avgICT($results->term)}}</td>
        <td class="centered">{{$avg6 = \App\Models\Grades\Std6::avgPDS($results->term)}}</td>
        <td class="centered">{{$avg7 = \App\Models\Grades\Std6::avgHis($results->term)}}</td>
        <td class="centered">{{$avg8 = \App\Models\Grades\Std6::avgGeog($results->term)}}</td>
        <td class="centered">{{$avg9 = \App\Models\Grades\Std6::avgCiv($results->term)}}</td>
        <td class="centered">{{$avg10 = \App\Models\Grades\Std6::avgVS($results->term)}}</td>
