...
<table class="mmm" style="margin-top:-3.5%; border-collapse:collapse;" border="1" >
    ...
    <tr>
        ...
        <td class="centered">{{$max1 = \App\Models\Grades\Std6::maxMath($results->term)}}</td>
        <td class="centered">{{$max2 = \App\Models\Grades\Std6::maxEng($results->term)}}</td>
        <td class="centered">{{$max3 = \App\Models\Grades\Std6::maxKis($results->term)}}</td>
        <td class="centered">{{$max4 = \App\Models\Grades\Std6::maxSc($results->term)}}</td>
        <td class="centered">{{$max5 = \App\Models\Grades\Std6::maxICT($results->term)}}</td>
        <td class="centered">{{$max6 = \App\Models\Grades\Std6::maxPDS($results->term)}}</td>
        <td class="centered">{{$max7 = \App\Models\Grades\Std6::maxHis($results->term)}}</td>
        <td class="centered">{{$max8 = \App\Models\Grades\Std6::maxGeog($results->term)}}</td>
        <td class="centered">{{$max9 = \App\Models\Grades\Std6::maxCiv($results->term)}}</td>
        <td class="centered">{{$max10 = \App\Models\Grades\Std6::maxVS($results->term)}}</td>
    ...
    <tr>
        ...
        <td class="centered">{{round($avg1 = \App\Models\Grades\Std6::avgMath($results->term))}}</td>
        <td class="centered">{{round($avg2 = \App\Models\Grades\Std6::avgEng($results->term))}}</td>
        <td class="centered">{{round($avg3 = \App\Models\Grades\Std6::avgKis($results->term))}}</td>
        <td class="centered">{{round($avg4 = \App\Models\Grades\Std6::avgSc($results->term))}}</td>
        <td class="centered">{{round($avg5 = \App\Models\Grades\Std6::avgICT($results->term))}}</td>
        <td class="centered">{{round($avg6 = \App\Models\Grades\Std6::avgPDS($results->term))}}</td>
        <td class="centered">{{round($avg7 = \App\Models\Grades\Std6::avgHis($results->term))}}</td>
        <td class="centered">{{round($avg8 = \App\Models\Grades\Std6::avgGeog($results->term))}}</td>
        <td class="centered">{{round($avg9 = \App\Models\Grades\Std6::avgCiv($results->term))}}</td>
        <td class="centered">{{round($avg10 = \App\Models\Grades\Std6::avgVS($results->term))}}</td>
