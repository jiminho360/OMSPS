...
<table class="mmm" style="width:100%;margin-top:-3.5%; border-collapse:collapse" border="1" >
    ...
    <tr>
        ...
        <td>{{$max1 = \App\Models\Grades\Std2::maxMath($results->term)}}</td>
    ...
    <tr>
        ...
        <td class="centered">{{$avg1 =\App\Models\Grades\Std2::avgMath($results->term)}}</td>
        <td class="centered">{{$avg2 =\App\Models\Grades\Std2::avgRead($results->term)}}</td>
        <td class="centered">{{$avg3 =\App\Models\Grades\Std2::avgWr($results->term)}}</td>
        <td class="centered">{{$avg4 =\App\Models\Grades\Std2::avgSc($results->term)}}</td>
