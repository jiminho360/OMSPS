...
<table class="mmm" style="margin-top:-3.5%; border-collapse:collapse;" border="1" >
    ...
    <tr>
        ...
        <td>{{$max1 = \App\Models\Grades\Std3::maxMath($results->term)}}</td>
    ...
    <tr>
        ...
        <td class="centered">{{$avg1 =\App\Models\Grades\Std3::avgMath($results->term)}}</td>
        <td class="centered">{{$avg2 =\App\Models\Grades\Std3::avgEng($results->term)}}</td>
        <td class="centered">{{$avg3 =\App\Models\Grades\Std3::avgKis($results->term)}}</td>
        <td class="centered">{{$avg4 =\App\Models\Grades\Std3::avgScTec($results->term)}}</td>
        <td class="centered">{{$avg4 =\App\Models\Grades\Std3::avgCivMor($results->term)}}</td>
        <td class="centered">{{$avg4 =\App\Models\Grades\Std3::avgSs($results->term)}}</td>
        <td class="centered">{{$avg4 =\App\Models\Grades\Std3::avgVS($results->term)}}</td>
