...
<table class="mmm" style="margin-top:-3.5%; border-collapse:collapse;" border="1" >
    ...
    <tr>
        ...
        <td class="centered">{{$max1 = \App\Models\Grades\Std3::maxMath($results->term)}}</td>
        <td class="centered">{{$max2 = \App\Models\Grades\Std3::maxEng($results->term)}}</td>
        <td class="centered">{{$max3 = \App\Models\Grades\Std3::maxKis($results->term)}}</td>
        <td class="centered">{{$max4 = \App\Models\Grades\Std3::maxScTec($results->term)}}</td>
        <td class="centered">{{$max4 = \App\Models\Grades\Std3::maxCivMor($results->term)}}</td>
        <td class="centered">{{$max4 = \App\Models\Grades\Std3::maxSs($results->term)}}</td>
        <td class="centered">{{$max4 = \App\Models\Grades\Std3::maxVS($results->term)}}</td>
    ...
    <tr>
        ...
        <td class="centered">{{round($avg1 =\App\Models\Grades\Std3::avgMath($results->term))}}</td>
        <td class="centered">{{round($avg2 =\App\Models\Grades\Std3::avgEng($results->term))}}</td>
        <td class="centered">{{round($avg3 =\App\Models\Grades\Std3::avgKis($results->term))}}</td>
        <td class="centered">{{round($avg4 =\App\Models\Grades\Std3::avgScTec($results->term))}}</td>
        <td class="centered">{{round($avg4 =\App\Models\Grades\Std3::avgCivMor($results->term))}}</td>
        <td class="centered">{{round($avg4 =\App\Models\Grades\Std3::avgSs($results->term))}}</td>
        <td class="centered">{{round($avg4 =\App\Models\Grades\Std3::avgVS($results->term))}}</td>
