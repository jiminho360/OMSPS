        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <table style="width: 100%;border-collapse: collapse; margin-top:0.2%">
                    ...
                    <tr>
                        <td>Non Current_Liability Name</td>
                        <td></td>
                        <td align="right"><b style="color: red">Non Current_Liability Value</b></td>
                        <td></td>
                        <td align="right"><b style="color: red">Non Current_Liabilities_sum</b></td>
                    </tr>
                    {{--<tr>--}}
                    {{--<td colspan="4"></td>--}}
                    {{--<td>--}}
