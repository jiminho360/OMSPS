@extends('layouts.app')
@section('title','Nationalities Lists')
            ...
            <div class="x_content">
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap"
                    ...
                    @foreach($nationalities as $nationality)
                        <tr>
                            <td class="desc_name">{{$nationality->name}}</td>
                            <td width="12%">
                                <a href="{{url('nationalities/edit/'.$nationality->id)}}" class="edit-btn"> Edit</a> |
                                <a href="{{url('nationalities/delete/'.$nationality->id)}}" class="delete-btn"> Delete</a>
            ...
            <div class="modal-content">
                <form action="{{url('Nationalities/store')}}" method="post">
                    ...
                    <div class="modal-header modal-header-color">
                        ...
                        <h4 class="modal-title"><strong>Add Nationality</strong></h4>
                    </div>
            ...
            <div class="modal-content">
                <form action="{{url('Nationalities/update')}}" method="post">
                    ...
                    <div class="modal-header modal-header-color">
                        ...
                        <h4 class="modal-title"><strong> Edit Nationality</strong></h4>
                    </div>
                    <div class="modal-body">
