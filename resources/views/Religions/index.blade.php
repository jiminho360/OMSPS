            ...
            <div class="x_content">
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap"
                    ...
                    @foreach($religions as $religion)
                        <tr>
                            <td class="desc_name">{{$religion->name}}</td>
                            <td width="12%">
                                <a href="{{url('Religions/edit/'.$religion->id)}}" class="edit-btn"> Edit</a> |
                                <a href="{{url('Religions/delete/'.$religion->id)}}" class="delete-btn"> Delete</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
            ...
            <div class="modal-content">
                <form action="{{url('religions/store')}}" method="post">
                    ...
                    <div class="modal-header modal-header-color">
                        ...
                        <h4 class="modal-title"><strong>Add Religion</strong></h4>
                    </div>
