            ...
            <div class="x_content">
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap"
                    ...
                    @foreach($user_types as $UserType)
                        <tr>
                            <td class="desc_name">{{$UserType->name}}</td>

                            <td style="width: 10%">
                                <a href="{{url('UserTypes/edit/'.$UserType->id)}}" class="edit-btn"> Edit</a> |
                                <a href="{{url('UserTypes/delete/'.$UserType->id)}}" class="delete-btn"> Delete</a>
