...
@section('title','Standard 4 Grades')
...
@section('content')
                ...
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap"
                    ...
                    @foreach($items as $key=>$item)
                        <tr>
                            ...
                            <td>
                                @if(\Illuminate\Support\Facades\Auth::user()->hasRole('academic_teacher'))
                                <a href="{{url('Std4/edit/'.$item->id)}}" class="edit-btn"> Edit</a> |
                                <a href="{{url('Std4/delete/'.$item->id)}}" class="delete-btn"> Delete</a>
                                @endif
                                <a href="{{url('Std4/show/'.$item->id)}}" class="btn-white"> View</a>
    ...
    <div class="modal fade" role="dialog" id="create" aria-hidden="true">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <form action="{{url('Std4/store')}}" method="post">
                    @csrf
                    ...
                    <div class="modal-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                ...
                                <input class="form-control input-sm" id="marks" autocomplete="off" name="marks" onkeypress="return isNumber(event)" type="text" required>
                            </div>
    ...
    <div class="modal fade" role="dialog" id="edit" aria-hidden="true">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <form action="{{url('Std4/update')}}" method="post">
                    @csrf
                    <div class="modal-header modal-header-color">
                        <button type="button"  class="close" data-dismiss="modal" aria-label="Close"><span
                                    aria-hidden="true">×</span>
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header modal-header-color">
                    ...
                    <h4 class="modal-title"><strong>Standard 4 Marks</strong></h4>
                </div>
                <div class="modal-body">
    ...
    <script>
        ...
        $("#edit").on('shown.bs.modal',function () {
            ...
            $(".lesson").change(function () {
                ...
                $.ajax({
                    url: '{{url('/grades/ajax/4')}}',
                    type: "GET",
                    data: {d_lesson: lesson, d_Std4: Std4_id},
                    dataType: "json",
