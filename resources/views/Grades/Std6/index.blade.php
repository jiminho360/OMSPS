...
@section('title','Standard 6 Grades')
...
--}}                            <td>
                                @if(\Illuminate\Support\Facades\Auth::user()->hasRole('academic_teacher'))
                                <a href="{{url('Std6/edit/'.$item->id)}}" class="edit-btn"> Edit</a> |
                                <a href="{{url('Std6/delete/'.$item->id)}}" class="delete-btn"> Delete</a>
                                @endif
                                <a href="{{url('Std6/show/'.$item->id)}}" class="btn-white"> View</a>
    ...
    <div class="modal fade" role="dialog" id="create" aria-hidden="true">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <form action="{{url('Std6/store')}}" method="post">
                    @csrf
    ...
    <div class="modal fade" role="dialog" id="edit" aria-hidden="true">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <form action="{{url('Std6/update')}}" method="post">
                    @csrf
                    <div class="modal-header modal-header-color">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                    aria-hidden="true">×</span>
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header modal-header-color">
                    ...
                    <h4 class="modal-title"><strong>Standard 6 Marks</strong></h4>
                </div>
                <div class="modal-body">
    ...
    <script>
        ...
        $("#edit").on('shown.bs.modal', function () {
            ...
            $(".lesson").change(function () {
                ...
                $.ajax({
                    url: '{{url('/grades/ajax/6')}}',
                    type: "GET",
                    data: {d_lesson: lesson, d_Std6: Std6_id},
                    dataType: "json",
