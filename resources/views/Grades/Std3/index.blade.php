...
@section('title','Standard 3 Grades')
...
@section('content')
    ...
    <div class="modal fade" role="dialog" id="create" aria-hidden="true">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <form action="{{url('Std3/store')}}" method="post">
                    @csrf
                    ...
                    <div class="modal-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                ...
                                <input class="form-control input-sm" autocomplete="off" id="marks" name="marks" onkeypress="return isNumber(event)" type="text" required>
                            </div>
    ...
    <div class="modal fade" role="dialog" id="edit" aria-hidden="true">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <form action="{{url('Std3/update')}}" method="post">
                    @csrf
                    <div class="modal-header modal-header-color">
                        <button type="button"  class="close" data-dismiss="modal" aria-label="Close"><span
                                    aria-hidden="true">×</span>
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header modal-header-color">
                    ...
                    <h4 class="modal-title"><strong>Standard 3 Marks</strong></h4>
                </div>
                <div class="modal-body">
    ...
    <script>
        ...
        $("#edit").on('shown.bs.modal',function () {
            ...
            $(".lesson").change(function () {
                ...
                $.ajax({
                    url: '{{url('/grades/ajax/3')}}',
                    type: "GET",
                    data: {d_lesson: lesson, d_Std3: Std3_id},
                    dataType: "json",
