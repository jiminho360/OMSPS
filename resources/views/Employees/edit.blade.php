...
<div class="form-group row">
    <div class="col-lg-4 col-md-4">
        ...
        <input class="form-control input-sm" id="email" name="email" type="email" value="{{$Employee->Email}}" required>
    </div>
    <div class="col-lg-4 col-md-4">
        <label class="control-label" for="phone">Phone Number</label>
        <input class="form-control input-sm" id="phone" name="phone" type="text" value="{{$Employee->phone}}" required>
    </div>
    <div class="col-lg-4 col-md-4">
        <label class="control-label" for="address">Physical Address</label>
        <input class="form-control input-sm" id="address" name="address" type="text" value="{{$Employee->Address}}" required>
    </div>
</div>
