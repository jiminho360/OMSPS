                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i>{{round(($nursery*100)/$totalStudents)}}% </i>Of Total Students</span>
                                    </div>
                                    <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                                    <span class="count_top"><i class="fa fa-user"></i>Total Standard One</span>
                                    <div class="count">{{$Std1}}</div>
                                    <span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i>{{round(($Std1*100)/$totalStudents)}}%</i>Of Total Students</span>
                                    </div>
                                    <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                                    <span class="count_top"><i class="fa fa-user"></i> Total Standard Two</span>
                                    <div class="count">{{$Std2}}</div>
                                    <span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i>{{round(($Std2*100)/$totalStudents)}}%</i>Of Total Students</span>
                                    </div>
                                    <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                                    <span class="count_top"><i class="fa fa-user"></i> Total Standard Three</span>
                                    <div class="count">{{$Std3}}</div>
                                    <span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i>{{round(($Std3*100)/$totalStudents)}}%</i>Of Total Students</span>
                                    </div>
                                    <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                                    <span class="count_top"><i class="fa fa-user"></i>Total Standard Four</span>
                                    <div class="count">{{$Std4}}</div>
                                    <span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i>{{round(($Std4*100)/$totalStudents)}}%</i>Of Total Students</span>
                                    </div>
                                    <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                                    <span class="count_top"><i class="fa fa-user"></i>Total Standard Five</span>
                                    <div class="count">{{$Std5}}</div>
                                    <span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i>{{round(($Std5*100)/$totalStudents)}}%</i>Of Total Students</span>
                                    </div>
                                        <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                                            <span class="count_top"><i class="fa fa-user"></i>Total Standard Six</span>
                                            <div class="count">{{$Std6}}</div>
                                            <span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i>{{round(($Std6*100)/$totalStudents)}}%</i>Of Total Students</span>
                                        </div>
                                        <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
