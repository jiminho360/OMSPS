...
@section('title','NonCurrent Liabilities')
...
@section('content')
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>NonCurrent Liabilities List</h2>
                ...
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap"
                    ...
                    @foreach($items as $key=>$item)
                        <tr>
                            ...
                            <td>{{$item->date}}</td>
                            <td style="width: 10%">
                                <a href="{{url('NonCurrentLiabilities/edit/'.$item->id)}}" class="edit-btn"> Edit</a> |
                                <a href="{{url('NonCurrentLiabilities/delete/'.$item->id)}}" class="delete-btn"> Delete</a>
    ...
    <div class="modal fade" role="dialog" id="create" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form action="{{url('NonCurrentLiabilities/store')}}" method="post">
                    @csrf
    ...
    <div class="modal fade" role="dialog" id="edit" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form action="{{url('NonCurrentLiabilities/update')}}" method="post">
                    @csrf
                    <div class="modal-header modal-header-color">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                    aria-hidden="true">×</span>
