...
@section('content')
                ...
                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap"
                    ...
                    @foreach($items as $key=>$item)
                        <tr>
                            ...
                            <td>{{$item->Date}}</td>
                            <td style="width: 10%">
                                <a href="{{url('Expenses/edit/'.$item->id)}}" class="edit-btn"> Edit</a> |
                                <a href="{{url('Expenses/delete/'.$item->id)}}" class="delete-btn"> Delete</a>
            ...
            <div class="modal-content">
                <form action="{{url('Expenses/store')}}" method="post">
                    ...
                    <div class="modal-header modal-header-color">
                        ...
                        <h4 class="modal-title"><strong>Add Expense</strong></h4>
                    </div>
    ...
    <div class="modal fade" role="dialog" id="edit" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form action="{{url('Expenses/update')}}" method="post">
                    @csrf
                    <div class="modal-header modal-header-color">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                    aria-hidden="true">×</span>
                        </button>
                        <h4 class="modal-title"><strong> Edit Expense</strong></h4>
                    </div>
                    <div class="modal-body">
